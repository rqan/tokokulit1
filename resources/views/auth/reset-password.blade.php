...
<head>
    ...
    <title>Reset Password — Eny Leather</title>
    ...
    <div class="max-w-md w-full bg-slate-800 border border-slate-700 p-8 rounded-xl space-y-6 shadow-xl">
        ...
        <form action="{{ url('/reset-password') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="password" required placeholder="••••••••" class="w-full bg-slate-900 border border-slate-700 p-3 rounded text-sm text-white focus:outline-none focus:border-amber-500">
            </div>

            <div>
                <label class="block text-xs uppercase tracking-widest text-slate-300 font-bold mb-2">Konfirmasi Password Baru</label>
                <input type="password" name="password_confirmation" required placeholder="••••••••" class="w-full bg-slate-900 border border-slate-700 p-3 rounded text-sm text-white focus:outline-none focus:border-amber-500">
            </div>
