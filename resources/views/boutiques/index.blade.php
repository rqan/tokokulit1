...
<head>
    ...
    <title>Boutiques - ENY LEATHER</title>
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto px-8 py-12 md:py-20">
        <div class="text-center mb-16">
            ...
            <p class="text-sm leading-relaxed text-lightMuted dark:text-darkMuted max-w-xl mx-auto">
                Discover our collections at authorized retailers and ENY LEATHER boutiques worldwide. Experience our savoir-faire firsthand.
            </p>
        </div>
