...
<body class="w-full relative antialiased selection:bg-lightMain selection:text-lightBg dark:selection:bg-darkMain dark:selection:text-darkBg bg-lightBg text-lightMain dark:bg-darkBg dark:text-darkMain">
    ...
    <main class="w-full min-h-screen py-20 px-8">
        <div class="max-w-4xl mx-auto text-center">
            <!-- Navigation Links -->
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 text-left">
            ...
            <h1 class="display-font text-5xl md:text-7xl mb-12">Our Story</h1>
            
            <img src="/images/products/leather_vest.jpg" alt="Store Origin" class="w-full h-[400px] object-cover mb-12 rounded grayscale">
