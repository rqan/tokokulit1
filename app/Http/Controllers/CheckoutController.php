...
class CheckoutController extends Controller
{
    ...
    public function process(CheckoutRequest $request)
    {
        ...
        // Validasi dan otorisasi sudah dihandle oleh CheckoutRequest
        ...
        $riskFlag = $isFirstTime || $frequentIp;
        $riskReason = $isFirstTime ? 'Nomor HP Baru' : ($frequentIp ? 'Frekuensi IP Tinggi' : null);
        ...
        $shippingData = $request->only(['shipping_name', 'shipping_email', 'shipping_phone', 'shipping_address', 'notes', 'province_id', 'city_id']);
